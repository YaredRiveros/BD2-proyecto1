...
int main(){
    ...
    // eh.insertRecord(Record(5, "nombre3", "apellido3", 2, "carrera3", 2)); //2 en binario es 101 -> bucket 1
    ...
    eh.insertRecord(Record(7, "nombre6", "apellido3", 2, "carrera3", 2)); //2 en binario es 111 -> bucket 2
